...
{
    /// <inheritdoc />
    public partial class PhaseD_Geography : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    StateName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedByUserId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cities_TenantId_CountryId_Name",
                table: "Cities",
                columns: new[] { "TenantId", "CountryId", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_Countries_TenantId_IsoCode",
                table: "Countries",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Localities_TenantId_CityId_Name",
                table: "Localities",
                columns: new[] { "TenantId", "CityId", "Name" });
